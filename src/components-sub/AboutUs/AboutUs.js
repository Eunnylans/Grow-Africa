...
{/*ABOUT SECTION*/}
      ...
      <div className="about-image">
        <div className="img-container">
          <img src={Image2} alt="Farmer in greenhouse" className="img-main" />
          <img src={Image1} alt="Farmer carrying produce" className="img-small" />
        </div>
      </div>
    </div>
      </div>
      ...
      <div className="about-content">
        ...
        <div className="about-text">
          ...
          <p className="description">
            Cosmos Agritech connects investors with smallholder farmers, driving
            food security and sustainable growth through impactful agricultural
            investments.
          </p>
          ...
          <p className="description">
            ...
            yields, and improve livelihoods. Through our platform, investors can
            support sustainable agriculture while earning returns, fostering a
            stronger and more resilient agricultural sector.
          </p>
        </div>
      </div>
    </div>
